...
<head lang="en">
    ...
    <link type="text/css" rel="stylesheet" href="<%=path%>/graph/correlation/all.css" />
    ...
    <script type="text/javascript" charset="utf8" src="<%=path%>/graph/correlation/correlation.js"></script>
